...
const operation = {
    details : {
        description: "Standard retrieve operation for craftsmanForm"
    },
    /** 
     * 
    ...
    */
    ...
    loadWebOperation: function(serviceManager, httpObj)
    {
        ...
        */
        ...
        let resourceName = 'craftsman2Page';
       ...
       //check if there is any input criteria for order
        ...
        serviceManager.callOperation("craftsman2", resourceName, "findOperation", 
